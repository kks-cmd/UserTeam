...
.ke-toolbar-icon-url {
	background-image: url(/dist/images/default_4a1cec120d21d39048974839029b4789.png);
}
...
.ke-dialog-icon-close {
	display: block;
	background: url(/dist/images/default_4a1cec120d21d39048974839029b4789.png) no-repeat scroll 0px -688px;
	width: 16px;
	height: 16px;
	position: absolute;
	right: 6px;
