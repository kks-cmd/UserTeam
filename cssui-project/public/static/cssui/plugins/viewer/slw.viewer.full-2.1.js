...
(function($) {
	...
	SlwPlugins.SlwViewer = function(el, option) {
        ...
        this.el = $(el);
        this.view = new SlwPlugins.View(this);
	    this.cmd = new SlwPlugins.Cmd(this);
	}
	/**
	...
	SlwPlugins.SlwViewer.prototype = {
        ...
        load : function() {
            ...
            $images.each(function(i) {
                ...
                that.loadImage(imgInfo.url, preView);
    ...
    SlwPlugins.View.prototype = {
        ...
        view : function(index) {
            ...
            that.loadImage(image.url, viewImage);
        },
        getImage : function() {
